...
class Actions extends AbstractDisplayer
{
    ...
    public function setEditActionResource($resource)
    {
        $this->editActionResource = $resource;
    }
    ...
    {
        $resource = $this->editActionResource ?: "{$this->getResource()}/{$this->getKey()}/edit"; 
        return <<<EOT
<a href="$resource">
